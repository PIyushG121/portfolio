...
export const projects = [
  {
    ...
    short_description: 'Comprehensive FinTech platform featuring prop firm comparisons, broker evaluations, cashback rewards, webinars, and mentorship portals.',
    category: 'Client Project / FinTech',
    filterCategory: 'filter-web',
    image: 'assets/img/portfolio/tradefluenza.svg',
    image_path: 'assets/img/portfolio/tradefluenza.svg',
    tags: ['React.js', 'Tailwind CSS', 'RESTful APIs', 'FinTech', 'Prop Trading', 'Lucide Icons'],
    tech_stack: ['React.js', 'Tailwind CSS', 'RESTful APIs', 'FinTech', 'Prop Trading', 'Lucide Icons'],
    liveDemoUrl: 'https://tradefluenza.com/',
    external_link: 'https://tradefluenza.com/',
    codeUrl: '',
    github_link: '',
  ...
  },
  {
    ...
    short_description: 'A smart finance management platform to track expenses, set budgets, and get AI-powered financial insights.',
    ...
    tech_stack: ['Laravel', 'React.js', 'MySQL', 'Tailwind CSS', 'Chart.js', 'Gemini AI'],
    ...
    github_link: 'https://github.com/PIyushG121/lar_proj',
  ...
  },
  {
    ...
    short_description: 'AI-powered resume parser and analyzer using NLP, RAG, and vector embeddings to extract insights and match job descriptions.',
    category: 'AI / ML',
    filterCategory: 'filter-ai',
    image: 'assets/img/resumeAnalyser.png',
    image_path: 'assets/img/resumeAnalyser.png',
    tags: ['Python', 'LangChain', 'FAISS', 'Gemini API', 'Streamlit', 'NLP'],
    tech_stack: ['Python', 'LangChain', 'FAISS', 'Gemini API', 'Streamlit', 'NLP'],
    liveDemoUrl: 'https://colab.research.google.com/drive/1KW1Hf_jceukhj-oZRFHvrNODGwTBWp3S',
    external_link: 'https://colab.research.google.com/drive/1KW1Hf_jceukhj-oZRFHvrNODGwTBWp3S',
    codeUrl: 'https://colab.research.google.com/drive/1KW1Hf_jceukhj-oZRFHvrNODGwTBWp3S',
    github_link: 'https://colab.research.google.com/drive/1KW1Hf_jceukhj-oZRFHvrNODGwTBWp3S',
  ...
  },
  {
    ...
    short_description: 'QR-based attendance system with real-time tracking, analytical reports, and role-based administrative control.',
    category: 'Web Application',
    filterCategory: 'filter-web',
    image: 'assets/img/attendence.png',
    image_path: 'assets/img/attendence.png',
    ...
    external_link: 'https://attendence.lookhype.com/',
    codeUrl: 'https://attendence.lookhype.com/',
    github_link: 'https://attendence.lookhype.com/',
